...
fn test_is_creator_registered_different_creators_independent() {
    ...
    client.register_creator(&alice, &String::from_str(&env, "alice"), &None);
...
fn test_register_creator_duplicate_different_handle_fails() {
    ...
    let result = client.try_register_creator(&creator, &String::from_str(&env, "alice_v2"), &None);
    assert_eq!(result, Err(Ok(ContractError::AlreadyRegistered)));
}
...
fn test_register_creator_different_addresses_succeeds() {
    ...
    client.register_creator(&alice, &String::from_str(&env, "alice"), &None);
    client.register_creator(&bob, &String::from_str(&env, "bob"), &None);
...
fn test_register_creator_accepts_min_handle_length() {
    ...
    client.register_creator(&creator, &String::from_str(&env, &min_handle), &None);
...
fn test_register_creator_accepts_max_handle_length() {
    ...
    client.register_creator(&creator, &String::from_str(&env, &max_handle), &None);
...
fn test_register_creator_rejects_handle_shorter_than_min() {
    ...
    let result = client.try_register_creator(&creator, &String::from_str(&env, &short_handle), &None);
...
fn test_register_creator_rejects_handle_longer_than_max() {
    ...
    let result = client.try_register_creator(&creator, &String::from_str(&env, &long_handle), &None);
...
fn test_register_creator_rejects_invalid_characters_in_handle() {
    ...
    let result = client.try_register_creator(&creator, &invalid_handle, &None);
...
fn test_register_creator_max_length_handle_succeeds() {
    ...
    client.register_creator(&creator, &max_handle, &None);
...
fn test_register_creator_handle_one_over_max_rejected() {
    ...
    let result = client.try_register_creator(&creator, &over_max_handle, &None);
